...
POOL_FILE="/sdcard/ARMY/providers/claude.providers"
POOL_SCRIPT="/sdcard/ARMY/setup/claude_provider_pool.py"
...
nohup "$PYTHON" "$POOL_SCRIPT" > "$LOG_DIR/claude-provider-pool.log" 2>&1 &
sleep 2
